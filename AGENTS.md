...
- Keep full-sheet duplicate cleanup batches small and well under the GAS limit; avoid trigger-wide deletion in the hot path, but remove stale resume triggers once cleanup is done.
